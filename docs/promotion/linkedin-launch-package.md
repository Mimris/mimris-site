...
This package turns approved Mimris website content into short LinkedIn posts. The website article is the canonical source; LinkedIn introduces the idea and links back to it.

## Editorial workflow

1. Draft or revise the article in `content/articles/`.
2. Review the article locally at `http://localhost:3002/articles`.
3. Approve the article title, wording, disclosure, and canonical URL.
4. Copy the matching post below into LinkedIn.
5. Add the recommended image and wait for the link preview.
6. Publish or schedule the post.
7. Record the published LinkedIn URL and date in the publication log at the end of this document.

Do not make a LinkedIn post carry a claim that is not supported by its linked Mimris page. Reply to useful comments with the canonical article link instead of creating an unsupported follow-up claim.
...
Explore the ecosystem: https://mimris-site.vercel.app/
...
Compare the products: https://mimris-site.vercel.app/products
...
Read the article: https://mimris-site.vercel.app/articles/why-ai-needs-models
...
Read the article: https://mimris-site.vercel.app/articles/from-biological-viability-to-artificial-consciousness

## Post 7 — Invitation

We are looking for people who work with complex domains, specialized language, interconnected deliverables, and AI-assisted projects.
...
- Confirm the linked page is approved and returns HTTP 200.

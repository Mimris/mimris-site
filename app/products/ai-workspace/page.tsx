  ...
  return (
    <>
      <PageHero eyebrow="Mimris AI Workspace" title="Put structured models to work." lead="An AI-enabled environment where a Universe becomes durable context for understanding, planning, performing, and reviewing real work.">
        <div className="button-row"><a className="button button-primary" href="https://mimris-ai-workspace.vercel.app">Open the workspace demo</a><a className="button button-secondary" href="/examples/coffee-shop">Follow the guided proof</a></div>
      </PageHero>

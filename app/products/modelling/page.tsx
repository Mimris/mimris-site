  ...
  return (
    <>
      <PageHero eyebrow="Mimris Modelling" title="Understand and model complex worlds." lead="A specialist modelling environment for defining model semantics and creating connected views of objects, relationships, processes, organizations, systems, and information.">
        <div className="button-row"><a className="button button-primary" href="https://mimris.vercel.app" data-analytics-event="product_demo_clicked" data-analytics-destination="modelling">Open the modelling demo</a><a className="button button-secondary" href="https://github.com/Mimris/mimris" data-analytics-event="source_clicked" data-analytics-destination="mimris-github">View public source</a></div>
      </PageHero>

...
export default function ModellingPage() {
  return (
    <>
      ...
      <section className="access-note access-note-green"><strong>Free, with no account required.</strong><p>Save and reopen your models locally. An account is not needed for normal Mimris Modelling use.</p><a className="arrow-link" href="/pricing">See plans and access <span aria-hidden="true">↗</span></a></section>
